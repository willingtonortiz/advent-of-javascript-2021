...
import pianoData from "./assets/data/piano-data";
...
const PIANO_DATA = pianoData;

const Day_03_Page = () => {
  useEffect(() => {
    document.title = "AOJ 2021 - Day 3";
  }, []);

  const playSound = (key: string) => {
    const tileAudio = PIANO_DATA.get(key)!;
